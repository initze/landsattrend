...
path_to_data = '/scratch/bbki/toddn/landsat-delta/landsattrend/data'

path_to_process = '/scratch/bbki/toddn/landsat-delta/landsattrend/data'

zones_to_upload = ['32602', '32603', '32604', '32605', '32606', '32607']
...
if __name__ == "__main__":
    for i in range(0, len(zones_to_upload)):
        ...
        path_to_zone_data = os.path.join(path_to_data, zone_name, '2000-2020', 'tiles')
        zone_files = os.listdir(path_to_zone_data)
        print('uploading these files for this zone')
        print(zone_files)
        for f in zone_files:
            path_to_f = os.path.join(path_to_zone_data, f)
            folder_name = 'process'
            file_id = upload_a_file_to_dataset_with_folder(path_to_f, zone_dataset,'process', url=clowder_url)
            file_id = upload_a_file_to_dataset(path_to_f, zone_dataset, url=clowder_url)
            print('uploaded file', f, file_id)
