...
def set_config_trend(PROCESS_SITE, STARTYEAR, ENDYEAR):
    global config_trend
    config_trend = {
      'date_filter_yr' : ee.Filter.calendarRange(STARTYEAR, ENDYEAR, 'year'),
      'date_filter_mth' : ee.Filter.calendarRange(STARTMONTH, ENDMONTH, 'month'),
...
def export_to_cloud(current_process_site, current_start_year, current_end_year):

    global PROCESS_SITE
    PROCESS_SITE = current_process_site
    global STARTYEAR
    STARTYEAR = current_start_year
    global ENDYEAR
    ENDYEAR = current_end_year

    set_config_trend(PROCESS_SITE, STARTYEAR, ENDYEAR)
    print(config_trend)
    print('that was config trend')
